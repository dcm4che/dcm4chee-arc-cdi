 ...
 *
 */
public class StowRSClient {

    private static final Logger LOG = LoggerFactory.getLogger(StowRSClient.class);
    
    private StowClientService service;
    private CStoreSCUContext context;
    
    public StowRSClient(StowClientService service, CStoreSCUContext context) {
        this.service = service;
        this.context = context; 
    }

    public StowServiceResponse storeOverWebService(Collection<ArchiveInstanceLocator> instances) {
    ...
    private boolean storeOverWebService(String aeTitle, String url
        ...
        try {
            ...
            connection = setupConnection(boundary, stowURL);
    ...
    private HttpURLConnection setupConnection(String boundary, URL url)
            throws IOException {
