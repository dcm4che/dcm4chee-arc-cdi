...
public class QCObject {
    ...
    private IDWithIssuerObject pid;
    private @JsonDeserialize(using = AttributesDeserializer.class)
    Attributes targetSeriesData;
    private @JsonDeserialize(using = AttributesDeserializer.class)
    Attributes updateData;
    private boolean samePatient;
    private CodeObject qcRejectionCode;
    ...
    public Attributes getTargetSeriesData() {
        return targetSeriesData;
    }

    public void setTargetSeriesData(Attributes orderData) {
        this.targetSeriesData = orderData;
    }

    public IDWithIssuerObject getPid() {
        return pid;
    }

    public void setPid(IDWithIssuerObject pid) {
        this.pid = pid;
    }
    ...
    public CodeObject getQcRejectionCode() {
        return qcRejectionCode;
    }

    public void setQcRejectionCode(CodeObject qcRejectionCode) {
