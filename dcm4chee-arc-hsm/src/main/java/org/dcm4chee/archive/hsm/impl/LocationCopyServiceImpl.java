 ...
 */
@ApplicationScoped
public class LocationCopyServiceImpl implements LocationCopyService {
    ...
    @Override
    public LocationCopyContext createContext(String targetGroupID) {
        LocationCopyContext ctx = new LocationCopyContext();
        ctx.setTargetStorageSystemGroupID(targetGroupID);
        return ctx;
    }

    @Override
    public void copyStudy(LocationCopyContext ctx, String studyIUID, long delay) throws IOException {
        ejb.scheduleStudy(ctx, studyIUID, delay);
    }

    @Override
    public void copySeries(LocationCopyContext ctx, String seriesIUID, long delay)
            throws IOException {
