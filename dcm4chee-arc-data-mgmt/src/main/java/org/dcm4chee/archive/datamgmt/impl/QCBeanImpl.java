...
import org.dcm4chee.archive.datamgmt.DataMgmtEvent.DataMgmtOperation;
...
//        for(RejectionParam rn: codes) {
//            if(rn.isQCRejection())
//                cofiguredQCRejection = codeService.findOrCreate(new Code(rn.getRejectionNoteTitle()));
//        }
//        source.setRejectionNoteCode(cofiguredQCRejection);
//
//        if(fully) {
//            //schedule delete here
//        }
    }
...
//                cofiguredQCRejection = codeService.findOrCreate(new Code(rn.getRejectionNoteTitle()));
//        }
//        RejectionParam param = RejectionParam.forRejectionNoteTitle(cofiguredQCRejection, codes);
//        rejectionService.reject("QC", instances, cofiguredQCRejection, param.getOverwritePreviousRejection());
    }
    ...
    public void updateDicomObject(ArchiveDeviceExtension arcDevExt,
        ...
        DataMgmtEvent updateEvent = new DataMgmtEvent(DataMgmtOperation.UPDATE,scope,attrs, null, null);
        notify(updateEvent);
    }
    ...
    private Study deleteStudy(String studyInstanceUID) throws Exception {
    ...
    private Series deleteSeries(String seriesInstanceUID) throws Exception {
    ...
    private Instance deleteInstance(String sopInstanceUID) throws Exception {
    ...
    private boolean deleteSeriesIfEmpty(String seriesInstanceUID,
    ...
    private boolean deleteStudyIfEmpty(String studyInstanceUID) {
        TypedQuery<Study> query = em.createNamedQuery(
                Study.FIND_BY_STUDY_INSTANCE_UID, Study.class).setParameter(1,
                studyInstanceUID);
        Study study = query.getSingleResult();
