...
/**
 * Base implementation for C-FIND SCPs using a {@link QueryService}.
 * 
 * @author Hermann Czedik-Eysenberg <hermann-agfa@czedik.net>
 */
public abstract class QueryCFindSCP extends BasicCFindSCP {

    protected final QueryRetrieveLevel rootLevel;
    ...
    public QueryCFindSCP(String sopClass, QueryRetrieveLevel rootLevel) {
        super(sopClass);
    ...
    protected QueryTask calculateMatches(Association as, PresentationContext pc,
        ...
        try {
            ...
            Query query = createQuery(ctx, relational);
            try {
                query.initQuery();
                query.executeQuery();
            } catch (Exception e) {
            ...
            return new QueryTaskImpl(as, pc, rq, ctx.getKeysOriginal(), rootLevel, query, queryService);
    ...
    protected abstract Query createQuery(QueryContext ctx, boolean relational) throws DicomServiceException;
