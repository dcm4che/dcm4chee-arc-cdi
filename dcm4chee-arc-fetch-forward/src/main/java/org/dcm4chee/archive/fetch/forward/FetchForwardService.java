...
public interface FetchForwardService {
    ...
    List<ArchiveInstanceLocator> fetchForwardUsingWado(String localAETitle, List<ArchiveInstanceLocator> externallyAvailable, 
            FetchForwardCallBack callBack);

    BasicCStoreSCUResp fetchForwardUsingCmove( int allInstances,
            BasicCStoreSCUResp finalResponse,
            List<ArchiveInstanceLocator> externallyAvailable,
            Association storeas, int priority, FetchForwardCallBack callBack);
