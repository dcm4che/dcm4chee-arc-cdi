...
create index FK877EA1F9265C5DAA on rel_instance_location (location_fk);
create index FK877EA1F937EDB1AA on rel_instance_location (instance_fk);
...
create index FK125A8F0A4BDB761E on study_on_stg_sys (study_fk);
