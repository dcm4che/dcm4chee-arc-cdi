 ...
 *
 */
public class StoreVerifyResponse {
    ...
    public StoreVerifyResponse(StoreVerifyStatus status, STORE_VERIFY_PROTOCOL storeVerifyProtocol, String transactionUID, String localAET, 
            String remoteAET, String retrieveAET, Map<String,VerifiedInstanceStatus> verifiedInstances) {
    ...
    public static class VerifiedInstanceStatus {
        private final Availability availability;
        private final String retrieveAET;
        
        public VerifiedInstanceStatus(Availability availability, String retrieveAET) {
