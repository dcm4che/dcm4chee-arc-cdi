...
public class MppsEmulationNotCompletedIT extends MppsEmulationGeneral {
    ...
    public void setup() throws Exception {
        ...
        // but then it doesnt sends a mpps-set
    ...
    public void emulate() throws Exception {
        ...
        assertTrue("mpps status not " + MPPS.IN_PROGRESS, receivedMpps
                .getStatus().equals(MPPS.Status.IN_PROGRESS));
    ...
    public static WebArchive createDeployment() {
        return createWar(MppsEmulationNotCompletedIT.class);
    }
