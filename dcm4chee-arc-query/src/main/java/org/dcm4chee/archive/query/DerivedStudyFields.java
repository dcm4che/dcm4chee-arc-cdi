 ...
 */
public interface DerivedStudyFields {
    ...
    /**
     * @return retrieve AETs associated to this Study
     */
    String[] getRetrieveAETs();

    /**
     * @return Study availability (ONLINE,NEARLINE,OFFLINE,UNAVAILABLE)
     */
    Availability getAvailability();

    /**
     * @return PKs of Series in this Study
     */
    Set<Long> getSeriesPKs();

    /**
     * @return Modalities in this Study
     */
    Set<String> getMods();

    /**
     * @return SOP Class UIDs in this Study
     */
    Set<String> getCuids();

    /**
     * @return Last Update Time of the Study (proprietary field)
     */
