...
@Decorator
public class DerivedStudyFieldsDynamicDecorator extends DynamicDecoratorWrapper<DerivedStudyFields> implements DerivedStudyFields {
	@Inject
	@Delegate
	...
	public Set<Long> getSeriesPKs() {
		return wrapWithDynamicDecorators(delegate).getSeriesPKs();
	}

	@Override
	public Set<String> getMods() {
		return wrapWithDynamicDecorators(delegate).getMods();
	}

	@Override
	public Set<String> getCuids() {
		return wrapWithDynamicDecorators(delegate).getCuids();
	}
