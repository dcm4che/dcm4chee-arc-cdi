...
public class IDatasetRule extends ExternalResource {

    final String dataSetXmlFilename;
    
    IDataSet iDataSet;

    public IDatasetRule(String dataSetXmlFilename) {
    ...
    protected void before() throws Throwable {
        ...
        iDataSet = flatXmlDataSetBuilder.build(Thread.currentThread()
                ...
                .getResourceAsStream(dataSetXmlFilename));
    }
